...
#ifndef DAYLIGHTMAP_HPP
#define DAYLIGHTMAP_HPP
...
class QSettings;
class StelButton;
class DaylightMapDialog;

/*! @defgroup daylightmap Daylight Map plug-in
@{
The Daylight Map plugin provides global Earth illumination tools,
...
class DaylightMapStelPluginInterface : public QObject, public StelPluginInterface
{
	Q_OBJECT
