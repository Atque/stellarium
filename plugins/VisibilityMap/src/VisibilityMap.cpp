...
StelModule* VisibilityMapPluginInterface::getStelModule() const
{
	return new DaylightMap();
}

StelPluginInfo VisibilityMapPluginInterface::getPluginInfo() const
{
	...
	info.description = N_("This plugin shows a world map of where the currently selected object is "
	                       "visible above the horizon, with isolines of equal altitude at culmination "
	                       "and a configurable \"good visibility\" threshold.");
